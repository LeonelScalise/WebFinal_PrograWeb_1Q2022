  ...
  return (
    ...
    <div className='flex flex-col mx-auto align-center w-9/12'>
      {sessionStorage.getItem("estaLogueado") === "true" ?
        <button class="flex justify-center self-center sm:self-end w-36 bg-transparent hover:shadow-lg hover:shadow-blue-400/50 hover:bg-blue-400 text-blue-700 font-semibold mt-6 hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded transition-colors" onClick={irAPaginaDeCrearObra}>Agregar obra</button>
        : null
      }
