...
const obrasPorDefecto = [
  {
    id: 1,
    titulo: "Obra en Quilmes",
    descripcion: "Prueba de obra 1",
    imagen:
      "https://www.telam.com.ar/thumbs/bluesteel/advf/imagenes/2019/08/5d52dce05cb0c_900.jpg",
  ...
  },
  {
    ...
    imagen:
      "https://cloudfront-us-east-1.images.arcpublishing.com/infobae/VTVLSQKMGZC3JA2RR7QEMQLTZE.jpg",
...
function borrarObraQueTieneID(unIdDeObraABorrar) {
  ...
  const obrasFiltradas = obrasAlmacenadas().filter(
    (obra) => obra.id !== unIdDeObraABorrar
  );
...
function setearComoObras(unaListaDeObras) {
  console.log(unaListaDeObras);
  console.log(JSON.stringify(unaListaDeObras));
